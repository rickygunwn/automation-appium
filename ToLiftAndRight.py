...
el3 = driver.find_elements(by=AppiumBy.XPATH, value="//android.widget.TextView[@resource-id='com.google.android.contacts:id/cliv_name_textview']")
print(len(el3))

actions = TouchAction(driver)
# actions.tap(el3[2]).perform()
actions.long_press(el3[2]).perform()
